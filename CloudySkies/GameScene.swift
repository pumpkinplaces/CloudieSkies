...
class GameScene: SKScene {
    ...
    private func firstLaunchSettings(){
        if UserDefaults().bool(forKey: "First Launch") == true{
            ...
            AllBunnyInfo.ownsList["Bunny"] = true; AllBunnyInfo.ownsList["YellowRabbita"] = false; AllBunnyInfo.ownsList["BrownRabbit"] = false; AllBunnyInfo.ownsList["BeigeBunny"] = true; AllBunnyInfo.ownsList["Shiny"] = false; AllBunnyInfo.ownsList["LightBrownBunny"] = false; AllBunnyInfo.ownsList["DarkBrownBunny"] = false; AllBunnyInfo.ownsList["GreenRabbita"] = false; AllBunnyInfo.ownsList["BlueRabbita"] = false; AllBunnyInfo.ownsList["GrayRabbita"] = false; AllBunnyInfo.ownsList["PinkRabbita"] = false; AllBunnyInfo.ownsList["Rabbita"] = false; AllBunnyInfo.ownsList["OrangeRabbita"] = false; AllBunnyInfo.ownsList["RedRabbita"] = false; AllBunnyInfo.ownsList["PurpleRabbita"] = false
